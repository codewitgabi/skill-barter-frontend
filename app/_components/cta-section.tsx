        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-linear-to-br from-[#10b981] via-[#3b82f6] to-[#8b5cf6] rounded-3xl p-8 sm:p-12 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: "200ms" }}>
                Join thousands of members who are learning new skills and building their networks through skill bartering.
              </p>

              {/* Trust Indicators */}
              <div className="flex flex-wrap items-center justify-center gap-6 mb-8 animate-fade-in-up" style={{ animationDelay: "400ms" }}>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-white" />
                  <span className="text-white/90 text-sm">10K+ Active Members</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-white" />
                  <span className="text-white/90 text-sm">2K+ Successful Exchanges</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-white" />
